...
def get_config():
    ...
    Prepare parameters:
        --algorithm_name <algorithm_name>
            specifiy the algorithm, including `["trl", "trl_dec"]`
        --experiment_name <str>
    ...
    PPO parameters:
        ...
        --use_gae
            by default, use generalized advantage estitrlion. If set, do not use gae.
        --gamma <float>
    ...
    parser = argparse.ArgumentParser(
        description='onpolicy', fortrlter_class=argparse.RawDescriptionHelpFortrlter)

    # prepare parameters
    parser.add_argument("--algorithm_name", type=str,
                        default='trl', choices=["trl", "trl_dec", "trl_encoder", "trl_decoder"])
    ...
    parser.add_argument("--use_gae", action='store_false',
                        default=True, help='use generalized advantage estitrlion')
